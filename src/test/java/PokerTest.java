...
public class PokerTest {
    ...
    @Test
    public void should_return_playerA_win_when_playerA_vs_playerB_given_playerA_3H_4D_5S_6C_7D_playerB_3H_3D_5S_9C_3D() {
        // given
        Player playerA = new Player("playerA",
                Arrays.asList(new Poker("3", "H"), new Poker("4", "D"), new Poker("5", "S"), new Poker("6", "C"), new Poker("7", "D")));
        Player playerB = new Player("playerB",
                Arrays.asList(new Poker("3", "H"), new Poker("3", "D"), new Poker("5", "S"), new Poker("9", "C"), new Poker("3", "D")));
    ...
    @Test
    public void should_return_playerA_lose_when_playerA_vs_playerB_given_playerA_3H_4D_5S_6C_7D_playerB_2H_3H_5H_9H_KH() {
        // given
        Player playerA = new Player("playerA",
                Arrays.asList(new Poker("3", "H"), new Poker("4", "D"), new Poker("5", "S"), new Poker("6", "C"), new Poker("7", "D")));
        Player playerB = new Player("playerB",
                Arrays.asList(new Poker("2", "H"), new Poker("3", "H"), new Poker("5", "H"), new Poker("9", "H"), new Poker("K", "H")));
    ...
    @Test
    public void should_return_playerA_win_when_playerA_vs_playerB_given_playerA_3H_3D_5S_5C_3D_playerB_2H_3H_5H_9H_KH() {
        // given
        Player playerA = new Player("playerA",
                Arrays.asList(new Poker("3", "H"), new Poker("3", "D"), new Poker("5", "S"), new Poker("5", "C"), new Poker("3", "D")));
        Player playerB = new Player("playerB",
                Arrays.asList(new Poker("2", "H"), new Poker("3", "H"), new Poker("5", "H"), new Poker("9", "H"), new Poker("K", "H")));
    ...
    @Test
    public void should_return_playerA_lose_when_playerA_vs_playerB_given_playerA_3H_3D_5S_5C_3D_playerB_3H_3D_3S_5C_3D() {
        // given
        Player playerA = new Player("playerA",
                Arrays.asList(new Poker("3", "H"), new Poker("3", "D"), new Poker("5", "S"), new Poker("5", "C"), new Poker("3", "D")));
        Player playerB = new Player("playerB",
                Arrays.asList(new Poker("3", "H"), new Poker("3", "D"), new Poker("3", "S"), new Poker("5", "C"), new Poker("3", "D")));
    ...
    @Test
    public void should_return_playerA_win_when_playerA_vs_playerB_given_playerA_3H_4H_5H_6H_7H_playerB_3H_3D_3S_5C_3D() {
        // given
        Player playerA = new Player("playerA",
                Arrays.asList(new Poker("3", "H"), new Poker("4", "H"), new Poker("5", "H"), new Poker("6", "H"), new Poker("7", "H")));
        Player playerB = new Player("playerB",
                Arrays.asList(new Poker("3", "H"), new Poker("3", "D"), new Poker("3", "S"), new Poker("5", "C"), new Poker("3", "D")));
